...
def verifica_password():
    ...
    st.write("Inserisci le credenziali aziendali per accedere alla pianificazione del personale.")
    ...
    with col1:
        ...
        if st.button("Accedi"):
            # Sostituisci 'amministrazione' e 'Turni2026!' con le tue credenziali desiderate
            if username == "amministrazione" and password == "Turni2026!":
...
# Blocca l'esecuzione se le credenziali non sono corrette
if verifica_password():
    ...
    # Calcolo automatico della riga finale ORE DIPENTI (Totale ditta)
